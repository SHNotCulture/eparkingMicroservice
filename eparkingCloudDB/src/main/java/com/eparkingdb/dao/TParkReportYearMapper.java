...
import com.eparkingdb.dao.sqlProvider.TParkReportYearSqlProvider;
import org.apache.ibatis.annotations.*;
import org.apache.ibatis.type.JdbcType;

import java.util.List;

public interface TParkReportYearMapper {
    /**
     ...
     * @mbg.generated
     */
    @SelectProvider(type= TParkReportYearSqlProvider.class, method="countByExample")
    long countByExample(TParkReportYearCriteria example);
     ...
     * @mbg.generated
     */
    @DeleteProvider(type=TParkReportYearSqlProvider.class, method="deleteByExample")
    int deleteByExample(TParkReportYearCriteria example);
     ...
     */
    @Delete({
        "delete from t_park_report_year",
     ...
     */
    @Insert({
        "insert into t_park_report_year (id, business_circle_total, ",
    ...
    int insert(TParkReportYear record);
     ...
     * @mbg.generated
     */
    @InsertProvider(type=TParkReportYearSqlProvider.class, method="insertSelective")
    int insertSelective(TParkReportYear record);
     ...
     * @mbg.generated
     */
    @SelectProvider(type=TParkReportYearSqlProvider.class, method="selectByExample")
    @Results({
    ...
    List<TParkReportYear> selectByExample(TParkReportYearCriteria example);
    ...
    TParkReportYear selectByPrimaryKey(Integer id);
     ...
     * @mbg.generated
     */
    @UpdateProvider(type=TParkReportYearSqlProvider.class, method="updateByExampleSelective")
    int updateByExampleSelective(@Param("record") TParkReportYear record, @Param("example") TParkReportYearCriteria example);
     ...
     * @mbg.generated
     */
    @UpdateProvider(type=TParkReportYearSqlProvider.class, method="updateByExample")
    int updateByExample(@Param("record") TParkReportYear record, @Param("example") TParkReportYearCriteria example);
     ...
     * @mbg.generated
     */
    @UpdateProvider(type=TParkReportYearSqlProvider.class, method="updateByPrimaryKeySelective")
    int updateByPrimaryKeySelective(TParkReportYear record);
    ...
    int updateByPrimaryKey(TParkReportYear record);
}