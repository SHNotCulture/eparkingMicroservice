...
import com.common.entity.eparkingCloud.TParkStatisticsDayCriteria.Criteria;
import com.common.entity.eparkingCloud.TParkStatisticsDayCriteria.Criterion;
import org.apache.ibatis.jdbc.SQL;

import java.util.List;
import java.util.Map;

public class TParkStatisticsDaySqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(TParkStatisticsDayCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("t_park_statistics_day");
     ...
     * @mbg.generated
     */
    public String deleteByExample(TParkStatisticsDayCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("t_park_statistics_day");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String insertSelective(TParkStatisticsDay record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("t_park_statistics_day");
        ...
        if (record.getStatisticTime() != null) {
            sql.VALUES("statistic_time", "#{statisticTime,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated
     */
    public String selectByExample(TParkStatisticsDayCriteria example) {
        SQL sql = new SQL();
        ...
        sql.FROM("t_park_statistics_day");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TParkStatisticsDay record = (TParkStatisticsDay) parameter.get("record");
        TParkStatisticsDayCriteria example = (TParkStatisticsDayCriteria) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("t_park_statistics_day");
        ...
        if (record.getStatisticTime() != null) {
            sql.SET("statistic_time = #{record.statisticTime,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(TParkStatisticsDay record) {
        SQL sql = new SQL();
        sql.UPDATE("t_park_statistics_day");
        ...
        if (record.getStatisticTime() != null) {
            sql.SET("statistic_time = #{statisticTime,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, TParkStatisticsDayCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
