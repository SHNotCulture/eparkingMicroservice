...
import com.common.entity.eparkingCloud.TPropertyBillItemsCriteria.Criteria;
import com.common.entity.eparkingCloud.TPropertyBillItemsCriteria.Criterion;
import org.apache.ibatis.jdbc.SQL;

import java.util.List;
import java.util.Map;

public class TPropertyBillItemsSqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(TPropertyBillItemsCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("t_property_bill_items");
     ...
     * @mbg.generated
     */
    public String deleteByExample(TPropertyBillItemsCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("t_property_bill_items");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String insertSelective(TPropertyBillItems record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("t_property_bill_items");
        ...
        if (record.getItemsAmount() != null) {
            sql.VALUES("items_amount", "#{itemsAmount,jdbcType=DOUBLE}");
        }
     ...
     * @mbg.generated
     */
    public String selectByExample(TPropertyBillItemsCriteria example) {
        SQL sql = new SQL();
        ...
        sql.SELECT("items_amount");
        sql.SELECT("create_time");
        sql.SELECT("update_time");
        sql.SELECT("user_id");
        sql.FROM("t_property_bill_items");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TPropertyBillItems record = (TPropertyBillItems) parameter.get("record");
        TPropertyBillItemsCriteria example = (TPropertyBillItemsCriteria) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("t_property_bill_items");
        ...
        if (record.getItemsAmount() != null) {
            sql.SET("items_amount = #{record.itemsAmount,jdbcType=DOUBLE}");
        }
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(TPropertyBillItems record) {
        SQL sql = new SQL();
        sql.UPDATE("t_property_bill_items");
        ...
        if (record.getItemsAmount() != null) {
            sql.SET("items_amount = #{itemsAmount,jdbcType=DOUBLE}");
        }
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, TPropertyBillItemsCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
