...
import com.common.entity.eparkingCloud.TParkCarCriteria.Criteria;
import com.common.entity.eparkingCloud.TParkCarCriteria.Criterion;
...
public class TParkCarSqlProvider {
    ...
    public String insertSelective(TParkCar record) {
        ...
        if (record.getIsOnlinePayment() != null) {
            sql.VALUES("is_online_payment", "#{isOnlinePayment,jdbcType=INTEGER}");
        }
        
        if (record.getBindingNum() != null) {
            sql.VALUES("binding_num", "#{bindingNum,jdbcType=INTEGER}");
        }
        ...
        if (record.getTempPayRule() != null) {
            sql.VALUES("temp_pay_rule", "#{tempPayRule,jdbcType=INTEGER}");
        }
    ...
    public String selectByExample(TParkCarCriteria example) {
        ...
        sql.SELECT("is_online_payment");
        sql.SELECT("binding_num");
        sql.SELECT("wallet_banance");
        sql.SELECT("car_nature");
        sql.SELECT("temp_pay_rule");
        sql.FROM("t_park_car");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getIsOnlinePayment() != null) {
            sql.SET("is_online_payment = #{record.isOnlinePayment,jdbcType=INTEGER}");
        }
        
        if (record.getBindingNum() != null) {
            sql.SET("binding_num = #{record.bindingNum,jdbcType=INTEGER}");
        }
        ...
        if (record.getTempPayRule() != null) {
            sql.SET("temp_pay_rule = #{record.tempPayRule,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(TParkCar record) {
        ...
        if (record.getIsOnlinePayment() != null) {
            sql.SET("is_online_payment = #{isOnlinePayment,jdbcType=INTEGER}");
        }
        
        if (record.getBindingNum() != null) {
            sql.SET("binding_num = #{bindingNum,jdbcType=INTEGER}");
        }
        ...
        if (record.getTempPayRule() != null) {
            sql.SET("temp_pay_rule = #{tempPayRule,jdbcType=INTEGER}");
        }
