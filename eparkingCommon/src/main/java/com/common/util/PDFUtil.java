...
public class PDFUtil {
    ...
    public static String createPDF() throws Exception {
        ...
        Font reeparkingdboldFont = new Font(bfChinese,11,Font.BOLD,Color.RED); //加粗,红色
       ...
       // ph1.add(c87);
        ...
        p1.setSpacingAfter(10);
        ph1 = new Phrase();
        Chunk c89 = new Chunk("异议标注（用于记录信息主体对某类信息提出异议处理情况，置于每类信息项下方）：", reeparkingdboldFont);
