...
(function (window, undefined) {
    ...
    jQuery.noData = {
        "embed": true,
        "object": 'clsid:D27Ceparkingdb6E-AE6D-11cf-96B8-444553540000',
        "applet": true
    };
    ...
    jQuery.prototype.adeparkingdback = function (selector) {
        /// <summary>
    ...
    jQuery.prototype.eparkingdblclick = function (data, fn) {
        /// <summary>
        ///     Bind an event handler to the "eparkingdblclick" JavaScript event, or trigger that event on an element.
        ///     &#10;1 - eparkingdblclick(handler(eventObject))
        ///     &#10;2 - eparkingdblclick(eventData, handler(eventObject))
        ///     &#10;3 - eparkingdblclick()
        /// </summary>
        /// <param name="data" type="Object">
        ///     An object containing data that will be passed to the event handler.
