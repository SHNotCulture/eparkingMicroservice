    ...
    <script type="text/javascript">
        ...
        layui.use(['table','form','layer','laydate'], function() {
            ...
            tableIns=table.render({
                ...
                ,height: 600
                ,url: '../tChargeDetailsReport/getDutyStatisticsbyPage' //数据接口
                ,method:'post'
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'dutyPerson', title: '当班员', width: 160, align:'center'}
...
/*                    case 'chargeReportStatistics':
        ...
        $(document).ready(function () {
            ...
            //初始化页面查询时间区间赋值当前时间前一天
            $("#beginTime").val(chargeReportForm.getYesterdayDate()+' 00:00:00');
            $("#endTime").val(chargeReportForm.getYesterdayDate()+' 23:59:59');
        })
        var parkList;
        //车场更新表单使用方法
        var chargeReportForm={
            ...
            getYesterdayDate: function() {//获取当前时间前一天
...
<#--            <button class="layui-btn layui-btn-sm" lay-event="chargeReportExcel">导出当班统计</button>-->
...
<body>
<blockquote class="layui-elem-quote">当班统计查询</blockquote>
<form class="layui-form " style="margin: 10px">
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="width: 200px;">
                <input type="text" class="layui-input" name="beginTime" id="beginTime" lay-verify="required|timeCheck">
            </div>
            <div class="layui-form-mid">至</div>
            <div class="layui-input-inline" style="width: 200px;">
                <input type="text" class="layui-input" name="endTime" id="endTime" lay-verify="required|timeCheck">
            </div>
