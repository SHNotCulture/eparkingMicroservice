    ...
    <script type="text/javascript">
        ...
        layui.use(['table', 'form', 'layer', 'laydate'], function () {
            ...
            tableIns = table.render({
                ...
                , height: 540
                , width: 'full-200'
                , url: '../parkingRecord/getParkinoutUnlimitByPage' //数据接口
                , method: 'post'
                ...
                , cols: [[ //表头
                    ...
                    , {field: 'carStatus', title: '车辆状态',align: 'left', width: 100, templet: '#carStatusTemp'}
                    ...
                    , {field: 'couponType', title: '减免类型', width: 90, align: 'center', templet: '#couponTypeTemp'}
...
/*                $.ajax({
            ...
            RecordExcel: function (object) {
                window.location.href = "../Base/exportListRecord?outPortId=" + object.outPortId + "&outType=" + object.outType + "&inCarPlate=" + object.inCarPlate + "&inCardCode=" + object.inCardCode + "&inTime=" + object.inTime + "&outTime=" + object.outTime + "&dutyPerson=" + object.dutyPerson;
            },
...
<#--        <a class="layui-btn layui-btn-xs" lay-event="busineCouponDetail">优惠详情</a>-->
    ...
    <script type="text/html" id="RecordToolbar">
        <div class="layui-btn-container">
            <button class="layui-btn layui-btn-sm" lay-event="RecordExcel">导出停车记录信息</button>
        </div>
    </script>
    <style type="text/css">
        ul li .carStyle {
...
<body>
<blockquote class="layui-elem-quote">停车记录</blockquote>
<div id="ringNum">
