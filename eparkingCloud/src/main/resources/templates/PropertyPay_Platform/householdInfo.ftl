...
<head>
 ...
 /*           var uploadInst = upload.render({
                elem: '#householdInfoImport' //绑定元素
                ,url: '/Base/importHouseHoldInfo' //上传接口
                ,accept:'file'
...
<form class="layui-form" style="margin: 10px" id="householdInfoForm" lay-filter="householdInfoForm">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="width: 200px;">
                <button class="layui-btn"  id="householdInfoImport" lay-submit lay-filter="householdInfoImport"><i class="layui-icon">&#xe67c;</i>住户批量导入</button>
            </div>
        </div>
    </div>
</form>
